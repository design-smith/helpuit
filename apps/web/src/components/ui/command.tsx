  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "flex h-10 w-full rounded-base bg-transparent py-3 text-sm outline-none placeholder:text-main-foreground placeholder:opacity-50 disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        {...props}
      />
