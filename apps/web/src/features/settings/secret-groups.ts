...
const SPECS: GroupSpec[] = [
  ...
  { id: 'intercom', title: 'Intercom', usedBy: 'Replying to Intercom conversations + verifying webhooks.', match: (k) => k.startsWith('INTERCOM_') },
  { id: 'freshdesk', title: 'Freshdesk', usedBy: 'Polling and replying to Freshdesk tickets.', match: (k) => k.startsWith('FRESHDESK_') },
  { id: 'hubspot', title: 'HubSpot', usedBy: 'Polling and replying to HubSpot conversations.', match: (k) => k.startsWith('HUBSPOT_') },
  { id: 'zendesk', title: 'Zendesk', usedBy: 'Replying to Zendesk tickets + verifying webhooks.', match: (k) => k.startsWith('ZENDESK_') },
