...
// Neobrutalism tabs — ported from the operator console (apps/web).
function Tabs({
  className,
  ...props
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "mt-3 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        className,
      )}
      {...props}
    />
